...
vignette: >
  %\VignetteIndexEntry{RNA-seq analysis is easy as 1-2-3 with limma, Glimma and edgeR (English version)}
...
To get started with this analysis, extract the data files from the archive file *GSE63310_RAW.tar*. The code below will do this, or you can do this step manually and then move on.

```{r downloadData, eval=TRUE}
utils::untar(system.file("extdata", "GSE63310_RAW.tar", package = "RNAseq123workshop"), exdir = ".")
